export default {
  ...
  nav: {
    ...
    darkMode: '深色模式',
    officialMode: '官方模式',
    gundamMode: 'Gundam 模式',
    gundamLiteMode: 'Gundam Lite',
    currentUIMode: '当前',
    uiModeSelector: '界面模式',
    officialModeShort: '官方',
    switchToGundamMode: '切换到 Gundam',
    switchToGundamLiteMode: '切换到 Gundam Lite',
    switchToOfficialMode: '切换到官方模式',
    collapse: '收起',
    expand: '展开',
    logout: '退出登录',
    github: 'GitHub',
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportModeSub2apiHint: '直接导入系统导出的账号数据。',
      dataImportModeCpa: 'CPA JSON',
      dataImportModeCpaHint: '将 CPA token 文件转换为 sub2api 账号导入格式。',
      dataImportMultiJsonHint: '支持选择多个 JSON 文件',
      ...
      cpaPriority: '默认优先级',
      cpaNameSource: '命名方式',
      cpaNameSourceEmail: '邮箱优先',
      cpaNameSourceFilename: '文件名',
      cpaNameSourceIndex: '序号',
      cpaNamePrefix: '序号前缀',
      cpaPreview: 'CPA 转换预览：{files} 个文件，将导入 {accounts} 个账号，命名方式 {name_source}。',
