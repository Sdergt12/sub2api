export default {
  ...
  nav: {
    ...
    gundamMode: 'Gundam Mode',
    gundamLiteMode: 'Gundam Lite',
    currentUIMode: 'Current',
    uiModeSelector: 'UI Mode',
    officialModeShort: 'Official',
    switchToGundamMode: 'Switch to Gundam',
    switchToGundamLiteMode: 'Switch to Gundam Lite',
    switchToOfficialMode: 'Switch to Official',
    collapse: 'Collapse',
    expand: 'Expand',
    logout: 'Logout',
    github: 'GitHub',
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportMode: 'Import format',
      dataImportModeSub2api: 'sub2api JSON',
      dataImportModeSub2apiHint: 'Import account data exported by this system directly.',
      dataImportModeCpa: 'CPA JSON',
      dataImportModeCpaHint: 'Convert CPA token files into sub2api account import data.',
      dataImportMultiJsonHint: 'Multiple JSON files are supported',
      ...
      cpaPlatform: 'Account platform',
      cpaAccountType: 'Account type',
      cpaConcurrency: 'Default concurrency',
      cpaPriority: 'Default priority',
      cpaNameSource: 'Name source',
      cpaNameSourceEmail: 'Email first',
      cpaNameSourceFilename: 'Filename',
      cpaNameSourceIndex: 'Index',
      cpaNamePrefix: 'Index prefix',
      cpaPreview: 'CPA preview: {files} files, {accounts} accounts will be imported, name source {name_source}.',
